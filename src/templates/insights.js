                  ...
                  <div className="recommend-card">
                    <div className="recommend-subcard">
                      ...
                      <div className="recommend-date">
                        <Moment format={"YYYY/MM/DD HH:MM"} date= {(_.get(latest_post, "frontmatter.date", null))}></Moment>
                      </div>
                      <Link
                        className="recommend-image"
                        to={withPrefix(_.get(latest_post, "url", null))}
                  ...
                  <article className="recommend-container">
                    <div className="recommend-card">
                      ...
                      <div className="recommend-subcard">
                        ...
                        <div className="recommend-date">
                          <Moment format={"YYYY/MM/DD HH:MM"} date= {post.frontmatter.date}></Moment>  
                        </div>
                        <Link
                  ...
                  <div className="recommend-card">
                    <div className="recommend-subcard">
                      ...
                      <div
                        ...
                        style={{ width: "300px" }}
                      >
                        <Moment format={"YYYY/MM/DD HH:MM"} date= {_.get(post, "frontmatter.date", null)}></Moment>  
                      </div>
                      <Link
                        className="recommend-image"
                        style={{ width: "300px" }}
